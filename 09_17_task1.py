...
def main():
    ziemelmeita = Song("Jumprava", "Ziemelmeita", ["Gāju meklēt Ziemeļmeitu","garu tālu ceļu veicu","un atradu to grāvi beigtu"])
    ziemelmeita.sing(1).sing(2).sing(3).sing(4)

    # zrap = Rap("Jumprava", "Ziemelmeita", ["Gāju meklēt Ziemeļmeitu","garu tālu ceļu veicu","un atradu to grāvi beigtu"])
    # zrap.Rap
